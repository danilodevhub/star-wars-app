...
export default function PersonDetailsError({
  ...
  return (
    <div className="max-w-[800px] mx-auto p-[30px] bg-[#ffffff] rounded-[4px] shadow-[0_1px_2px_0_var(--warm-grey-75)] border border-[var(--gainsboro)] flex flex-col items-center">
      <h1 className="text-[24px] font-[700] mb-[15px] text-center">Error Loading Person Details</h1>
      
      <p className="text-[16px] mb-[30px] text-center">
        We couldn't fetch the details for this character from the Star Wars API.
        <br />
        This might be because the character doesn't exist or the API is temporarily unavailable.
      </p>
